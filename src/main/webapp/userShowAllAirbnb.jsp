        ...
        <script>
            ...
            res=res+ "<div class=\"col-md-4 home-grid\">";
                                res=res+"<div class=\"item item-type-move\">";
                                   res=res+"<a class=\"item-hover\" href=\"userShowSingleAirbnbDetails.jsp?detailid="+st.detailid+"\" >";						
...
<!--        <div class="top-header">
        ...
        <div class="home-block">
            <div class="container">
                <div class="home-main">
                    <div class="home-top">
                        <h3 style='font-family:Brush Script'><b><em>Properties</em></b></h3>
                    </div>
                    <div id="cities" >
