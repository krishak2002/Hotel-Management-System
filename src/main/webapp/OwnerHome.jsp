...
<!--        <div class="top-header">
        ...
        <!--header end here-->
            ...
            <div class="container">
                <div class="home-main">
                    <div class="home-top">
                        <h3 style='font-family:Brush Script'><b>Welcome to Owner Home</b></h3>
                    </div>
                    <div id="cities" >
                        <div class="home-bottom  wow bounceInLeft" data-wow-delay="0.3s">
                            <div class="col-md-4 home-grid">
                                <div class="item item-type-move">
                                    <a class="item-hover" href="OwnerManageProperties.jsp">						
                                        <div class="item-info">
                                            <div class="headline">
                                            
                                            </div>
                                            <div class="date"><h2 style='font-family:Brush Script'><b>Manage Properties</b></h2></div>							
                                        </div>
                                        <div class="mask"> </div>
                                    </a>
                                    <div class="item-img">
                                        <img src="MyUploads/villa1.jpg" style="height: 210px; width: 350px" class="img-responsive" alt="">
                                    </div>
                                </div>
                    				...
                    				<div class="col-md-4 home-grid">
                                                            <div class="item item-type-move">
                                                                    <a class="item-hover" href="OwnerManageBookings.jsp">						
                                                                            <div class="item-info">
                                                                                    <div class="headline">
                                                                                       
                                                                                    </div>
                                                                                <div class="date"><h2 style='font-family:Brush Script'><b>Manage Bookings</b></h2></div>							
                                                                            </div>
                                                                            <div class="mask"> </div>
                                                                </a>
                                                                    <div class="item-img">
                                                                                    <img src="MyUploads/booking.jpg" style="height: 210px; width: 350px" class="img-responsive" alt="">
                                                                    </div>
                                                            </div>
                                                    </div>
                                                    <div class="col-md-4 home-grid">
                                                            <div class="item item-type-move">
                                                                    <a class="item-hover" href="OwnerEditProperties.jsp">						
                                                                            <div class="item-info">
                                                                                    <div class="headline">
                                                                                           
                                                                                           
                                                                                    </div>
                                                                                <div class="date"><h2 style='font-family:Brush Script'><b> Edit Properties</b></h2></div>							
                                                                            </div>
                                                                            <div class="mask"> </div>
                                                                </a>
                                                                    <div class="item-img">
                                                                                    <img src="MyUploads/editing.jpg" style="height: 210px; width: 350px" class="img-responsive" alt="">
                                                                    </div>
                                                            </div>
                                                    </div>
                    <div class="clearfix"> </div>
