		        ...
		        <nav class="navbar navbar-inverse navbar-static-top">
		            ...
		            <nav class="cl-effect-16" id="cl-effect-16">
		              <ul class="nav navbar-nav">
                                  ...
                                  <%
                                      String owneremail4 = (String) session.getAttribute("owneremail");
                                      
if(owneremail4 != null){
                                  %>
                                  <li><a class="active" href="" data-hover="Welcome: <%=owneremail4%>">Welcome: <%=owneremail4%></a></li>

                               <li><a class="active" href="ownerLogout.jsp" data-hover="Logout">Logout</a></li>
                                                         <%
                                    }
else{
